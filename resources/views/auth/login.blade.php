...
<body class="bg-gray-50 font-poppins text-slate-800 antialiased relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="relative w-full max-w-md p-8 bg-white/70 backdrop-blur-xl border border-white/50 rounded-2xl shadow-2xl mx-4">
        ...
        <div class="text-center mb-8">
            ...
            <h2 class="text-xl font-semibold text-slate-700">Welcome Back</h2>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-5">
            ...
            <div class="flex items-center justify-between">
                ...
                @if (Route::has('password.request'))
                    <a class="text-sm font-medium text-blue-600 hover:text-blue-500 transition-colors" href="{{ route('password.request') }}">
                        Forgot Password?
                    </a>
                @endif
            </div>
